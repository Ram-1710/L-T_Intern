<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserDashBoard.aspx.cs" Inherits="L_T_Defence.UserDashBoard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row ">
        <div class="col-sm">
            <h3><strong>Your Result</strong></h3>
        </div>
    </div>
    <div class="row ">
        <div class="col-12 mar imgcenter">

            <asp:Button ID="btnExam" CssClass="btn btn-primary" Style="float: right;" runat="server" Text="Take Test" OnClick="btnExam_Click" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 ">
            <div class="alert tablebg1 table-responsive">
                ...
                <asp:GridView ID="GridView1" AutoGenerateColumns="false"  EmptyDataText="No Matched Records Found" runat="server"
