<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LoginDetailsPage.aspx.cs" Inherits="L_T_Defence.LoginDetailsPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row ">
        <div class="col-sm">
            <h3><strong>Login Details</strong></h3>
        </div>
    </div>
    <div class="col-sm">
            ...
            <asp:GridView ID="GridView1" AutoGenerateColumns="false"  EmptyDataText="No Matched Records Found" DataKeyNames="UserId" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DepartmentName" HeaderText="Department" />
                     <asp:BoundField DataField="INorOUT" HeaderText="Log Status" />
                    <asp:BoundField DataField="LoginDate" HeaderText="Date and Time" />
                </Columns>
            </asp:GridView>
