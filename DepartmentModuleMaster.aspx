<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DepartmentModuleMaster.aspx.cs" Inherits="L_T_Defence.DepartmentModuleMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row ">
        <div class="col-sm">
            <h3><strong>Module Master</strong></h3>
        </div>
    </div>
        ...
        <div class="col-sm">
            <div class="alert tablebg1 table-responsive">
                <asp:GridView ID="GridView1" AutoGenerateColumns="false" DataKeyNames="ID" runat="server"
                    OnRowDataBound="GridView1_RowDataBound"  EmptyDataText="No Matched Records Found" OnRowCommand="GridView1_RowCommand"
                    ...
                    <Columns>
                        ...
                        <%-- <asp:TemplateField HeaderText="Delete">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="btnDelete" CommandName="Del" ImageUrl="~/images/delete.png" Width="20px" Height="20px" OnClientClick="return confirm('Are you sure you want to delete this record?')" />
            ...
            <div class="alert tablebg1">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-lg-3 mar">
                        ...
                        <asp:TextBox ID="txtModule" ValidationGroup="Department" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtModule" ForeColor="Red" ValidationGroup="Department"
                            runat="server" ErrorMessage="Please Enter the Module"></asp:RequiredFieldValidator>
                    </div>
                    <div class="col-sm-4 col-lg-4 mar"></div>
