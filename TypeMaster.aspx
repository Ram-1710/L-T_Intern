<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TypeMaster.aspx.cs" Inherits="L_T_Defence.TypeMaster" %>
    ...
    <div class="row">
        <div class="col-sm">
            <div class="alert tablebg1 table-responsive">
                <asp:GridView ID="GridView1" AutoGenerateColumns="false" DataKeyNames="TypeId" runat="server" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand"
                    ...
                    <Columns>
                        ...
                        <%-- <asp:TemplateField HeaderText="IsActive">
                            <itemtemplate>
                                <asp:ImageButton runat="server" ID="btnActive" CommandName="Act"
                                    ImageUrl='<%# Eval("ActiveFlag").ToString() == "1" ? "~/images/tick.png" : "~/images/cross.png" %>' Width="20px"
                                    Height="20px" />
                            </itemtemplate>
            ...
            <div class="alert tablebg1">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-lg-3 mar">
                        ...
                        <asp:TextBox ID="txtType" ValidationGroup="Department" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtType" ForeColor="Red" ValidationGroup="Department"
                            runat="server" ErrorMessage="Please Enter the Category"></asp:RequiredFieldValidator>
                    </div>
